...
def publishedArticles():
    ...
    get_articles = newsapi.get_everything(sources= 'google-news-in,the-hindu,the-times-of-india')
...
def topHeadlines():
    ...
    top_headlines = newsapi.get_top_headlines(sources= 'google-news-in,the-hindu,the-times-of-india')
...
def randomArticles():
    ...
    random_articles = newsapi.get_everything(sources= 'google-news-in,the-hindu,the-times-of-india')
